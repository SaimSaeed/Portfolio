            ...
            <div className=' container-fluid contact-box' id='contact'>
                <div className=' row'>
                    <div className=' col-6 contact-heading'>
                        ...
                        <ul  >
                            <li> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-telephone-outbound" viewBox="0 0 16 16">
                    ...
                    <div className=' col-6'>
                        ...
                        <div className='contact-form' >
                            <ul style={{ display: "flex", flexWrap: "wrap", listStyleType: "none" }}>
                                ...
                                <li style={{ width: "50%" }}><input type='text' placeholder='Subject *' style={{ borderBottom: "1px solid grey",backgroundColor: "rgb(215, 159, 17)" }} />  </li>
