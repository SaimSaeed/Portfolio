...
<div >
                    ...
                    <div className='col-12 col-sm-12 col-md-6 mt-3 about-detail'>
                        ...
                        <ul  className='row' style={{listStyle:"none"}} >
                            <li  className='col-6 col-sm-6 col-md-6 mb-4'>  <strong>Name:</strong> Saim Saeed</li>
                            <li  className='col-6 col-sm-6 col-md-6'> <strong>Email:</strong> saimsaeed640</li>
                            <li  className='col-6 col-sm-6 col-md-6 mb-4'> <strong>Phone/Whatsapp:</strong> +923045575062</li>
